...
var users = {
	...
	CollectData: function(tweet, tag) {
		...
		var calcul = (sthashtags[tag].timestamp_ms[sthashtags[tag].timestamp_ms.length] - sthashtags[tag].timestamp_ms[0]) / sthashtags[tag].nombredetweet;
